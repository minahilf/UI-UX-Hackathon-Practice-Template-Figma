        ...
        <div>
            ...
            <div className="flex flex-col mt-4 sm:flex-row sm:items-center sm:gap-[10%]">
                ...
                <div className="flex gap-4 items-center justify-center mt-4 lg:ml-[15%] xl:ml-[30%]">
                    <div className="bg-secondary rounded-full h-7 w-7">
                        <Image src={left} alt="Previous arrow" className="w-3 h-3 mt-2 ml-2" />
                    </div>
                    <div className="bg-secondary rounded-full h-7 w-7">
                        <Image src={righta} alt="Next arrow" className="w-3 h-3 mt-2 ml-2" />
                    </div>
                </div>
            </div>
